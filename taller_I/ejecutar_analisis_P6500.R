# Script para ejecutar el análisis completo de P6500
# Primero combina los datos y luego ejecuta el análisis dinámico

cat("=== ANÁLISIS COMPLETO DE P6500 ===\n")
...
# Paso 1: Combinar los datos de P6500
cat("PASO 1: Combinando datos de P6500 con función de limpieza mejorada...\n")
tryCatch({
...
if (file.exists("Combinados/Combinado_cuantitativo_P6500.csv")) {
  datos_limpios <- read.csv("Combinados/Combinado_cuantitativo_P6500.csv")
  cat("Primeros 10 valores de P6500:\n")
  print(head(datos_limpios$P6500, 10))
  cat("Resumen estadístico:\n")
  print(summary(datos_limpios$P6500))
  cat("\n")
}
...
if (!file.exists(data_file)) {
  stop(paste("El archivo", data_file, "no existe. Ejecutar primero combinar_datos_P6500.R"))
}
...
writeLines(analisis_content, "scripts_analisis/analisis_P6500_temp.R")

# Ejecutar el análisis
tryCatch({
  source("scripts_analisis/analisis_P6500_temp.R")
...
file.remove("scripts_analisis/analisis_P6500_temp.R")

cat("=== ANÁLISIS COMPLETADO ===\n")
cat("Resultados guardados en: analisis_P6500_cuantitativa/\n")
cat("Archivos generados:\n")
cat("- Gráficos en: analisis_P6500_cuantitativa/plots/\n")
cat("- Gráfico de consistencia: analisis_P6500_cuantitativa/consistencia_var_vs_n.png\n")
cat("- Datos combinados: Combinados/Combinado_P6500.csv\n")
